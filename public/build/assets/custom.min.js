...
const TableHelper = {
    dynamicTable: {
        ...
        buttons: [
            {
                text: "Add",
                className: "dt-button btn btn-sm btn-success",
                attr: {
            ...
            {
                text: "Excel",
                className: "dt-button btn btn-sm btn-primary",
            },
        ],
    },
